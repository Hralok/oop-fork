...
public class AngryAnimals : Animal, IDamageDealer
{
    protected int damage;

    public AngryAnimals(Cell currentCell, Fraction currentFraction, EntityTypeEnum selfEntityType, Information info)
