...
public class Alien : ChaoticAnimals
{
    public Alien(Cell currentCell, Fraction currentFraction, EntityTypeEnum selfEntityType, Information info, Gender gender = Gender.Neutral)
        : base(currentCell, currentFraction, selfEntityType, info)
    {
        ...
        initiative = 5;
        selfEntityType = EntityTypeEnum.Alien;
        resourceFromAttack = ResourceTypeEnum.RottenMeat;
        ...
        movementDevices.Add(new MovementDevice(RouteTypeEnum.Teleport, 15, MovementFieldEnum.Ground, 1, 1));
